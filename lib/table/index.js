    ...
    _createClass(Table, [{
        ...
        value: function componentWillMount() {
            ...
            this.extendInfo = {
                ...
                // 获取未选择列的信息
                getCurrentNotSelectRows: function getCurrentNotSelectRows() {
                    var datas = _lodash2.default.cloneDeep(_this2.state.datas);
                    return _lodash2.default.remove(datas, function (item, index) {
                        return !_this2.state.selectRowList.some(function (el) {
